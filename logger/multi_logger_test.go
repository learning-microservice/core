...
func TestMultiLogger(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expected: []string{
				`level=debug msg="debug message [111]"`,
				``,
			},
		},
		{
		...
		},
		{
			...
			expected: []string{
				`level=info msg="info message [111]"`,
				``,
			},
		},
		{
		...
		},
		{
			...
			expected: []string{
				`level=warning msg="warning message [111]"`,
				``,
			},
		},
		{
		...
		},
		{
			...
			expected: []string{
				``,
				`level=error msg="error message [111]"`,
			},
		},
		{
			configs: configs,
		...
		},
		{
			...
			expected: []string{
				``,
				`level=panic msg="panic message [111]"`,
			},
		},
	}
